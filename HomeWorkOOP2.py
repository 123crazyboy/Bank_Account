...
savingAccounts = {
    "dara": SavingAccount("Dara", 20000, 321),
    "visual": SavingAccount("Visual", 50000, 987),
    "chanthy": SavingAccount("Chanthy", 120000, 123),
}
student_Accounts = {
    "student1": StudentBankAccount("Student1", 50000, 456),
    "student2": StudentBankAccount("Student2", 70000, 654),
    "student3": StudentBankAccount("Student3", 80000, 999),
}
premiumAccounts = {
    "premium1": PremiumSaving("Premium1", 100000, 555),
    "premium2": PremiumSaving("Premium2", 200000, 666),
}
business_accounts = {
    "loantaker1": BusinessAccount("Loantaker1", 30000, 111),
    "loantaker2": BusinessAccount("Loantaker2", 40000, 121),
}
